...
/**
 * A LogReader class reads over all of the lines in a log file, and parses them into Log objects containing
...
public class LogReader {
    ...
    /**
     * Constructor for a LogReader.
     * @param logPath -- File path for the LogReader to read over.
    ...
    /**
     * Function for populating the log list of the LogReader. Called in the constructor.
